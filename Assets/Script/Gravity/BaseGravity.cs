...
namespace Assets.Script.Gravity
{
    ...
    public class BaseGravity
    {
        ...
        public virtual void ResetMatrix()
        {
            ...
            RandomMatrix(BaseGravity.m, BaseGravity.n);
            RenderMatrix(BaseGravity.m, BaseGravity.n);
        }

        public static bool IsCellInMaxtrix(Cell cell)
        {
            int m = BaseGravity.MATRIX.GetLength(0);
            int n = BaseGravity.MATRIX.GetLength(1);
        ...
        public static Cell GetCell(string name)
        {
            ...
            if (i == 0 || j == 0 || i == BaseGravity.m + 1 || j == BaseGravity.n + 1) return null;
            return new Cell(i, j);
