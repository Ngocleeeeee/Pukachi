...
namespace Assets.Script.AutoMatch
{
    ...
    public class BaseAI
    {
        ...
        public virtual void ResetMatrix()
        {
            ...
            RandomMatrix(BaseAI.m, BaseAI.n);
            RenderMatrix(BaseAI.m, BaseAI.n);
        }

        public static bool IsCellInMaxtrix(Cell cell)
        {
            int m = BaseAI.MATRIX.GetLength(0);
            int n = BaseAI.MATRIX.GetLength(1);
        ...
        public static Cell GetCell(string name)
        {
            ...
            if (i == 0 || j == 0 || i == BaseAI.m + 1 || j == BaseAI.n + 1) return null;
            return new Cell(i, j);
